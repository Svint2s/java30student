...
public class StudentController {
	...
	public StudentDto editStudent(@PathVariable int id, @RequestBody StudentUpdateDto studentUpdateDto) {
	...
	public List<StudentResponseDto> findStudentsByExamScore(@PathVariable(name = "exam") String examName,
		...
		return studentService.findStudentsByExamScores(examName, minScore);
	}
